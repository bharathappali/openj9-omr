...
typedef struct OMRCgroupEntry {
	...
	uint64_t flag; /**< flag of the cgroup*/
...
typedef struct OMRPortLibrary {
	...
	/** see @ref omrsysinfo.c::omrsysinfo_get_handle_cgroup_subsystem_file "omrsysinfo_get_handle_cgroup_subsystem_file"*/
	int32_t (*sysinfo_get_handle_cgroup_subsystem_file)(struct OMRPortLibrary *portLibrary,  uint64_t subsystemFlag, const char *fileName, FILE **file);
	/** see @ref omrsysinfo.c::omrsysinfo_get_cgroup_entry_list "omrsysinfo_get_cgroup_entry_list"*/
	OMRCgroupEntry* (*sysinfo_get_cgroup_entry_list)(struct OMRPortLibrary *portLibrary);
...
#define omrsysinfo_get_handle_cgroup_subsystem_file(param1,param2,param3) privateOmrPortLibrary->sysinfo_get_handle_cgroup_subsystem_file(privateOmrPortLibrary, param1, param2, param3)
#define omrsysinfo_get_cgroup_entry_list() privateOmrPortLibrary->sysinfo_get_cgroup_entry_list(privateOmrPortLibrary)
